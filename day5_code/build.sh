...
strip_virtualenv () {
    ...
    cp /outputs/*py $VIRTUAL_ENV

    pushd $VIRTUAL_ENV && zip -r -9 -q /tmp/aws_phot.zip *py ; popd
    pushd $VIRTUAL_ENV/lib/python3.6/site-packages/ && zip -r -9 --out /tmp/partial-venv.zip -q /tmp/aws_phot.zip * ; popd
